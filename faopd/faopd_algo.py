...
from faopd.drail import DRAILDiscrim
from faopd.flow_matching.flow_matching import FlowMatchingModel
...
class FAOPD(NestedAlgo):
    """
    FA-OPD that is identical to DRAIL in all respects except L_diff implementation.
...
class DecoupledFAOPD(NestedAlgo):
    """
    FA-OPD variant with decoupled discriminators (no label conditioning):
