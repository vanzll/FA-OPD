...
from faopd.drail_un import DRAIL_UN
from faopd.drail import DRAIL
from faopd.faopd_algo import FAOPD, DecoupledFAOPD
from faopd.get_policy import get_ppo_policy, get_basic_policy, get_diffusion_policy, get_deep_ddpg_policy, get_deep_sac_policy, get_deep_iqlearn_policy, get_deep_basic_policy
from faopd.get_policy import get_fmppo_policy, get_fm_a2c_policy
from faopd.fm_a2c import FMA2C
from faopd.get_policy import get_flow_matching_policy
from faopd.fpo_algo import FPOAlgo
...
def get_setup_dict():
    return {
        ...
        "diffusion-policy": (DiffPolicy(), partial(get_diffusion_policy, is_stoch=False)),
        ...
        "faopd": (FAOPD(), get_ppo_policy),  # ours
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Recording filtered metrics only: {allowed_metrics}")
    except ImportError:
        print("Metrics filter not available; recording all metrics")
