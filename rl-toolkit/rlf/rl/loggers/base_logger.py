...
class BaseLogger(object):
    ...
    def interval_log(
        ...
        # Apply metrics filtering when available.
        try:
            from utils.metrics_filter import filter_log_vals
            log_dat = filter_log_vals(log_dat)
        except ImportError:
            # Keep the original behavior when the filter is unavailable.
            pass
